...
const { create, list, ListAllBlogCategories, read,removeBlog, photo, popular, searchBlogGetByCategories, update, getBlogById, uploadPhoto } = require("../controller/blog");
